...
export default function MemberProfile({
  ...
  async function handleRemovePhoto() {
    ...
    try {
      ...
      alert(
        err instanceof Error ? err.message : t("profile.failedRemovePhoto"),
      );
    }
  }
  ...
  async function handleCoverUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      alert(
        err instanceof Error ? err.message : t("profile.failedUploadCover"),
      );
    }
  ...
  async function handleRemoveCover() {
    ...
    try {
      ...
      alert(
        err instanceof Error ? err.message : t("profile.failedRemoveCover"),
      );
    }
  }
  ...
  async function handleChangeEmail() {
    ...
    try {
      ...
      setEmailMsg(
        e instanceof Error ? e.message : t("profile.failedChangeEmail"),
      );
    }
  ...
  async function handleResetPassword() {
    ...
    try {
      ...
      setPasswordMsg(
        e instanceof Error ? e.message : t("profile.failedResetPassword"),
      );
    }
  ...
  async function handleChangePassword() {
    ...
    try {
      const wixClient = createClient({
        ...
        auth: OAuthStrategy({
          clientId: "2168e967-8e53-4561-b535-3fe367938245",
        }),
      });
      ...
      {tab === "profile" && (
        <>
          ...
          >
            ...
            <div>
              <div style={headerNameStyle}>
                {nickname || firstName || t("profile.unnamedCat")}
              </div>
          ...
          <form onSubmit={handleSave}>
            ...
            <h3 style={{ ...sectionHeadingStyle, marginTop: "40px" }}>
              {t("profile.about")}
            </h3>
          ...
          >
              ...
              <p
                style={{
                  ...
                  color:
                    ...
                    emailMsg.includes(t("profile.emailUpdated").substring(0, 5))
                      ? "#4caf50"
                      : "#cc0000",
                  marginTop: "8px",
                }}
            ...
            >
              ...
              <div style={{ marginBottom: "16px" }}>
                <label
                  style={{ ...labelStyle, fontSize: "0.8rem", color: "var(--text-secondary)" }}
                >
              ...
              <div style={{ paddingTop: "12px", borderTop: "1px solid var(--border-card)" }}>
                ...
                >
                  {passwordSending
                    ? t("profile.sending")
                    : t("profile.sendChangePasswordLink")}
                </button>
              </div>
                  ...
                  style={{
                    ...
                    color:
                      ...
                      passwordMsg.includes(
                        t("profile.passwordChanged")?.substring(0, 5),
                      ) ||
                      passwordMsg.includes(
                        t("profile.passwordResetSent").substring(0, 5),
                      )
                        ? "#4caf50"
                        : "#cc0000",
                    marginTop: "8px",
