...
const styles: Record<string, React.CSSProperties> = {
  ...
  emptyText: { color: "var(--text-muted)", marginBottom: "8px" },
  emptyHint: { color: "var(--text-dark)", fontSize: "0.8rem" },
  error: {
  ...
  holder: { fontSize: "0.8rem", color: "var(--text-secondary)" },
  exp: { fontSize: "0.8rem", color: "var(--text-muted)" },
