  ...
  if (wixVideo.startsWith("wix:video://")) {
    ...
    return {
      ...
      thumbnail: result.thumbnail
        ? getImageUrl(result.thumbnail, thumbnailWidth, thumbnailHeight)
        : null,
    };
  }

  return {
    url: `https://video.wixstatic.com/video/${wixVideo}/file`,
    thumbnail: null,
  };
}
...
export function extractMediaUrl(
  m: productsV3.ProductMedia | undefined,
  width = 800,
  height = 800,
): MediaEntry | null {
  if (!m) return null;
